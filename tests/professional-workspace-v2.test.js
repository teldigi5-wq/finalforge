...
test('professional workspace is loaded after responsive runtime ownership',async()=>{
  ...
  const style=loader.indexOf("loadStyle('assets/professional-workspace-v2.css')");
  ...
  assert.ok(style>=0,'professional workspace stylesheet is loaded');
  assert.match(loader,/const VERSION='professional-workspace-v2'/);
});
