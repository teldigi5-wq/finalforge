const C='finalforge-v5-firebase-live-8';
...
const INSTANT=new Set(['/','/index.html','/assets/core-loader.js','/assets/ui-responsive-v2.css','/assets/auth-experience-v4.css','/assets/auth-experience-v4.js','/assets/dashboard-modern-v3.css','/assets/practice-v3.js','/assets/practice-runtime-bridge.js','/assets/firebase-config.js','/assets/auth.js','/assets/finalforge-logo-256.webp']);
