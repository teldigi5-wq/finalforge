/* FinalForge production loader — auth-first paint, cached core reconstruction, parallel Firebase startup. */
(async()=>{
  const fail=(msg)=>{
  ...
  try{
    ...
    await Promise.all([loadStyle('assets/ui-responsive-v2.css'),loadStyle('assets/auth-experience-v4.css')]);
    critical.remove();
    ...
    /* Start Firebase networking while the local practice/experience code initializes. */
